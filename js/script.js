...
const WISH_MESSAGES = [
	...
	"Năm mới bình an",
	"Chúc bạn năm mới an vui 🎉",
	"Chúc bạn xuân sang rộn ràng 🌸",
	"Chúc bạn cả năm hanh thông 🍀",
	"Chúc bạn vạn sự như ý ✨",
	"Chúc bạn bình an đủ đầy 🧧",
	"Chúc bạn niềm vui trọn vẹn 😄",
	"Chúc bạn hạnh phúc sum vầy 🏮",
	"Chúc bạn tiền vào như nước 💸",
	"Chúc bạn làm ăn tấn tới 🚀",
	"Chúc bạn thành công nối dài 🏆",
	"Chúc bạn cười tươi mỗi ngày 😊",
	"Chúc bạn sức khỏe dồi dào 💪",
	"Chúc bạn phúc lộc tràn đầy 🌟",
	"Chúc bạn may mắn quanh năm 🍀",
	"Chúc bạn điều lành gõ cửa 🚪",
	"Chúc bạn cuộc đời thăng hoa 🌼",
];
